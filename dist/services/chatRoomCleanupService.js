...
class ChatRoomCleanupService {
    ...
    async cleanupExpiredRooms() {
      ...
      `);
            ...
            for (const room of expiredRooms) {
                ...
                await database_1.default.query('UPDATE chats SET status = $1 WHERE id = $2', ['expired', room.id]);
    ...
    async notifyRoomsEndingSoon() {
        try {
            // 24 saat içinde süresi dolacak odaları bul
            const soonToExpireResult = await database_1.default.query(`
        SELECT cr.*, 
               u1.first_name as user1_name, u1.username as user1_username,
               u2.first_name as user2_name, u2.username as user2_username,
      ...
      `);
            ...
            for (const room of soonToExpireRooms) {
                ...
                const lastNotificationResult = await database_1.default.query(`
...
exports.default = ChatRoomCleanupService;
